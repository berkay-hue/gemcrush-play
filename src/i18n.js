const DICT = {
  ...
  en: {
    ...
    account: 'Account', accountHint: 'Sign in to keep your progress on every device.', username: 'Username', password: 'Password (min 6)', login: 'Sign in', register: 'Create account', cancel: 'Cancel', logout: 'Sign out', loggedAs: 'Signed in:', saveCloud: 'Save / Sign in', welcomeBack: 'Welcome back!', authErr_kullanici_adi: 'Username: 3-20 letters/digits/_', authErr_sifre_kisa: 'Password needs 6+ characters', authErr_alinmis: 'Username is taken', authErr_hatali: 'Wrong username or password', authErr_ag: 'Connection error, try again',
