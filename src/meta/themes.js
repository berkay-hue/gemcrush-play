...
export const THEMES = [
  ...
  { id: 'forest', ground: 0x3f6f35, grassTint: [0x2f6b35, 0.35], leafTint: [0x1f4d2a, 0.25], trees: ['tree_pineTallA', 'tree_pineRoundA', 'tree_pineRoundC', 'tree_pineTallA', 'tree_detailed'], tr: 'Orman Kıyısı', en: 'Forest Edge', icon: '🌲', gems: 25, skyBase: 0x9fd0bc,
  ...
  { id: 'sunset', ground: 0x9a7a3a, grassTint: [0xd29a45, 0.45], leafTint: [0xe0823a, 0.55], trees: ['tree_fat_fall', 'tree_oak', 'tree_fat', 'tree_default'], tr: 'Gün Batımı', en: 'Sunset', icon: '🌅', gems: 10, skyBase: 0xffc49a,
  ...
  { id: 'winter', ground: 0xe6eef5, grassTint: [0xf4f8fc, 0.82], leafTint: [0xeef5fb, 0.6], trees: ['tree_cone', 'tree_pineTallA', 'tree_pineRoundA', 'tree_cone'], tr: 'Kış', en: 'Winter', icon: '❄️', gems: 20, skyBase: 0xd6e8f7,
