...
export const THEMES = [
  { id: 'meadow', tr: 'Çayır', en: 'Meadow', icon: '🌼', price: 0, skyBase: 0xa8dcf2, dress: [],
  ...
  { id: 'forest', tr: 'Orman Kıyısı', en: 'Forest Edge', icon: '🌲', gems: 25, skyBase: 0x9fd0bc,
  ...
  { id: 'river', tr: 'Dere Kenarı', en: 'Riverside', icon: '🏞️', gems: 30, skyBase: 0x8fd4f5,
  ...
  { id: 'sunset', tr: 'Gün Batımı', en: 'Sunset', icon: '🌅', gems: 10, skyBase: 0xffc49a,
  ...
  { id: 'winter', tr: 'Kış', en: 'Winter', icon: '❄️', gems: 20, skyBase: 0xd6e8f7,
  ...
  { id: 'quaternius', tr: 'Quaternius Çiftliği', en: 'Quaternius Farm', icon: '🐑', gems: 35, skyBase: 0xb5e2f5,
  ...
  { id: 'kaykit', tr: 'KayKit Köyü', en: 'KayKit Village', icon: '🏘️', gems: 45, skyBase: 0xa6d8f7,
