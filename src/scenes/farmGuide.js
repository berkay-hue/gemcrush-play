...
export const GUIDE = [
  ...
  ['🐝', ['Arıcılık', 'Beekeeping'], ['Seviye 12’de 🐝 Arı Kovanı kur (en fazla 4). Arılar değirmenin önündeki çiçeklerde uçar, 4 saatte bir 🍯 bal yapar. Bal pazarda en pahalı ürün; 3 bal = 🌈 prizma!', 'At level 12 set up a 🐝 Beehive (up to 4). Bees buzz by the windmill and make 🍯 honey every 4 hours. Honey sells best; 3 honey = 🌈 prism!']],
  ...
  ['👕', ['Kuzucuk’u giydir', 'Dress up Lambkin'], ['Sağdaki 👕 düğmesiyle gardırobu aç. Şapka, tulum ve aksesuar seç; ben çiftlikte hemen giyerim! Bazıları seviyeyle açılır.', 'Open the wardrobe with the 👕 button. Pick hats, overalls and extras — I wear them on the farm right away! Some unlock with levels.']],
